...
class Flow:
    ...
    def get_data(self) -> dict:
        ...
        data = {
            ...
            "cwe_flag_count": flag_count.has_flag("URG", PacketDirection.FORWARD),
            ...
            "subflow_fwd_byts": packet_length.get_total(PacketDirection.FORWARD),
...
if __name__ == "__main__":
    ...
    # subprocess.call("start /wait npcap-1.75.exe", shell=True)
